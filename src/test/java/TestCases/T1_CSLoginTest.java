...
public class T1_CSLoginTest extends CSProjectSpecification {
    ...
    public void CSLoginTest() throws InterruptedException {

        Test = Extent.createTest("Login Functionality","Checking whether Login function is running successfully");

        CSHomePage Obj = new CSHomePage(driver);
        //Obj.CSlaunchandLoad("edge","https://adactinhotelapp.com/index.php");
        Obj.loginClick()
                .Username("Sangee986")
                .Password("sangee123")
                .LoginButton()
